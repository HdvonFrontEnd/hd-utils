...
const branchManipulate = () => {
  ...
  execSync('git clone --depth 1 -b gh-pages --single-branch https://github.com/HdvonFrontEnd/hd-utils.git', { stdio: 'inherit' })
  process.chdir(path.join(process.cwd(), './hd-utils'))
  rimraf.sync('./**/*')
  execSync('cp -rf ../../lib/** .')
